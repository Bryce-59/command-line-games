...
class HangmanAgent():
    ...
    def _is_valid_letter(self, guess):
        ...
        return self._is_valid_guess(guess) or guess == var.SPACE_IN
    ...
    def is_terminal(self):
        ...
        for w in word:
            if w != var.SPACE_IN and (self._is_valid_guess(w) and w.lower() not in self._guesses_made):
                return False
...
class PlayerAgent(HangmanAgent):
    ...
    def _is_valid_letter(self, letter):
        return letter != var.SECRET and letter != var.SPACE_OUT 
